...
import { LogOut, Activity, Trophy, Calendar } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Επιδόσεις</CardTitle>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Το Dashboard του Αθλητή</CardTitle>
            <CardDescription>
              Εδώ θα μπορείτε να δείτε τις προπονήσεις, την πρόοδό σας και άλλες πληροφορίες.
            </CardDescription>
          </CardHeader>
          <CardContent>
