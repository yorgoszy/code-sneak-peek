    ...
    <footer id="footer" className="bg-black py-16 text-[#f4f1ea]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          {/* Επικοινωνία */}
          <div>
            <h3 className="text-xl font-bold mb-6 text-[#f4f1ea]" style={{ fontFamily: 'Robert Pro, sans-serif' }}>
          ...
          <div className="flex flex-col justify-center items-center">
            ...
            <div className="flex justify-center gap-6">
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="hover:opacity-80 transition-colors text-[#f4f1ea]"
              >
          ...
          <div className="md:ml-auto">
            ...
            <div className="space-y-2 text-[#f4f1ea]">
        ...
        <div className="text-center border-t border-gray-800 pt-8 mt-12 text-[#f4f1ea]">
