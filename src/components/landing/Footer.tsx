...
const Footer: React.FC<FooterProps> = ({ translations }) => {
  return (
    <footer id="footer" className="bg-black py-16" style={{ color: '#aca097' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col justify-center items-center">
            ...
            <div className="flex justify-center gap-6">
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="hover:opacity-80 transition-colors" style={{ color: '#aca097' }}
              >
        ...
        <div className="text-center border-t border-gray-800 pt-8 mt-12" style={{ color: '#aca097' }}>
