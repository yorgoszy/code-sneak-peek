    ...
    <footer id="footer" className="bg-white py-16 text-black">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          {/* Επικοινωνία */}
          <div>
            <h3 className="text-xl font-bold mb-6 text-black" style={{ fontFamily: 'Roobert Pro, sans-serif' }}>
          ...
          <div className="flex flex-col justify-center items-center">
            ...
            <div className="flex justify-center gap-6">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="footer-icon-link transition-colors text-black"
              >
        ...
        <div className="text-center border-t border-gray-200 pt-8 mt-12 text-black">
