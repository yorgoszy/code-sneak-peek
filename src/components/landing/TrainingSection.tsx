  ...
  return (
    <section className="relative bg-black min-h-[900px]">
      ...
      >
        ...
        >
          Στο γυμναστήριό μας δεν διδάσκουμε απλά ένα άθλημα - Επενδύουμε στη συνολική ανάπτυξη του παιδιού, καλλιεργώντας τη συναισθηματική του νοημοσύνη, τις κινητικές του ικανότητες και τις κοινωνικές του δεξιότητες. Στόχος μας να τους δώσουμε τα εφόδια που θα τους συνοδεύουν σε όλη τους τη ζωή.
        </p>
      </div>
