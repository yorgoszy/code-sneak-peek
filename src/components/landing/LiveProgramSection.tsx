      ...
      <section className="py-16 bg-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold mb-2 text-[#f4f1ea]" style={{ fontFamily: 'Robert Pro, sans-serif' }}>
              Live Program
            </h2>
              ...
              return (
                ...
                >
                  ...
                  <div className={cn(
                    ...
                    isClosed ? "text-red-400" : isToday ? "text-[#f4f1ea]" : "text-[#aca097]"
                  )}>
                    {dayNames[index]}
                  </div>
                  <div className={cn(
                    ...
                    {sectionsForSlot.map((section) => {
                      ...
                      return (
                        <div key={section.id} className="flex items-center gap-2 px-2 py-1.5 rounded-none bg-[#aca097]/10 border border-[#aca097]/30">
                          <span className={cn("text-[10px] font-semibold w-10 flex-shrink-0", isCurrentSlot ? "text-[#f4f1ea]" : "text-[#aca097]")}>{time}</span>
    ...
    <section className="py-20 bg-black">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold mb-4 text-[#f4f1ea]" style={{ fontFamily: 'Robert Pro, sans-serif' }}>Live Program</h2>
          <div className="w-16 h-1 mx-auto mb-4 bg-[#f4f1ea]"></div>
          <p className="text-[#f4f1ea]">{format(weekStart, 'dd/MM')} - {format(weekDays[6], 'dd/MM')}</p>
        </div>
            ...
            return (
              <div key={time} className="grid grid-cols-8 gap-0.5 min-w-0">
                <div className="bg-black border border-[#aca097]/30 rounded-none p-1 flex items-center justify-center">
                  <span className={cn("text-[10px] font-medium", isCurrentSlot ? "text-[#f4f1ea]" : "text-[#aca097]")}>{time}</span>
                </div>
                    ...
                    <div key={dateStr} className="border border-[#aca097]/30 rounded-none bg-[#aca097]/10 p-0.5 space-y-0.5">
                      {sectionsForSlot.map((section) => {
                        ...
                        return (
                          ...
                          >
                            <div className={cn("text-[8px] font-medium truncate", isHovered ? 'text-[#f4f1ea]' : 'text-[#aca097]')}>{section.name}</div>
