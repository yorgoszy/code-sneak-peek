    ...
    <div className="p-3 sm:p-4 md:p-6 space-y-4 md:space-y-6">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="rounded-none w-full flex flex-wrap h-auto gap-1 p-1">
          <TabsTrigger value="tests" className="rounded-none flex-1 min-w-[100px] text-xs sm:text-sm">
            <FlaskConical className="w-3 h-3 sm:w-4 sm:h-4 mr-1 sm:mr-2" />
            <span className="hidden xs:inline">Λειτουργικά</span> Τεστ
          </TabsTrigger>
          <TabsTrigger value="muscles" className="rounded-none flex-1 min-w-[100px] text-xs sm:text-sm">
