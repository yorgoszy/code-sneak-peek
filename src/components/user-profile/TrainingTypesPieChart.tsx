          ...
          <div className="flex items-center gap-1">
            <button
              ...
              className={`px-2 py-0.5 rounded-full text-[10px] font-medium transition-all ${
                timeFilter === 'day' ? 'bg-[#aca097] text-[#cb8954]' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'
              }`}
            >
              Ημέρα
            </button>
            <button
              ...
              className={`px-2 py-0.5 rounded-full text-[10px] font-medium transition-all ${
                timeFilter === 'week' ? 'bg-[#aca097] text-[#cb8954]' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'
              }`}
            >
              Εβδομάδα
            </button>
            <button
              ...
              className={`px-2 py-0.5 rounded-full text-[10px] font-medium transition-all ${
                timeFilter === 'month' ? 'bg-[#aca097] text-[#cb8954]' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'
              }`}
            >
              Μήνας
            </button>
