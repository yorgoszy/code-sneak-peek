  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <Card className="rounded-none">
          <CardHeader>
            <CardTitle className="text-sm">CMJ (Countermovement Jump)</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="space-y-2">
              <Label>Ύψος (cm)</Label>
        ...
        <Card className="rounded-none">
          <CardHeader>
            <CardTitle className="text-sm">SQJ (Squat Jump)</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="space-y-2">
              <Label>Ύψος (cm)</Label>
              <Input
                ...
                step="0.1"
                value={sqj}
                onChange={(e) => setSqj(e.target.value)}
                placeholder="π.χ. 42.3"
                className="rounded-none"
              />
            </div>
          </CardContent>
        ...
        <Card className="rounded-none">
          <CardHeader>
            <CardTitle className="text-sm">DJ Height (Drop Jump)</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="space-y-2">
              <Label>Ύψος (cm)</Label>
              <Input
                ...
                step="0.1"
                value={djHeight}
                onChange={(e) => setDjHeight(e.target.value)}
                placeholder="π.χ. 48.2"
                className="rounded-none"
              />
            </div>
          </CardContent>
        ...
        <Card className="rounded-none">
          <CardHeader>
            <CardTitle className="text-sm">DJ Contact Time</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="space-y-2">
              <Label>Χρόνος Επαφής (ms)</Label>
              <Input
                type="number"
                step="0.1"
                value={djContact}
        ...
        <Card className="rounded-none">
          <CardHeader>
            <CardTitle className="text-sm">RSI (Reactive Strength Index)</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="space-y-2">
              <Label>RSI</Label>
        ...
        <Card className="rounded-none">
          <CardHeader>
            <CardTitle className="text-sm">Asymmetry</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="space-y-2">
              <Label>Ασυμμετρία (%)</Label>
              <Input
                type="number"
                step="0.1"
                value={asymmetry}
