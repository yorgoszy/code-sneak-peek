...
import { Download, Smartphone, Check, Monitor, ArrowLeft, Calendar } from 'lucide-react';
import { Alert, AlertDescription } from '@/components/ui/alert';

export default function InstallCalendarWidget() {
      ...
      <Card className="max-w-2xl w-full rounded-none relative">
        ...
        <CardHeader className="text-center pt-12">
          <div className="mx-auto mb-4 w-20 h-20 rounded-full bg-[#00ffba]/10 flex items-center justify-center">
            <Calendar className="w-10 h-10 text-[#00ffba]" />
          </div>
          <CardTitle className="text-2xl">Ημερολόγιο Widget</CardTitle>
          <CardDescription>
            Εγκατάστησε το widget ημερολογίου για γρήγορη πρόσβαση στις προπονήσεις σου
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          {!isMobile && (
            <Alert className="rounded-none border-[#cb8954]/20 bg-[#cb8954]/5">
              ...
              <AlertDescription>
                <strong>Σημαντικό:</strong> Για να εγκαταστήσεις το widget, πρέπει να ανοίξεις αυτή τη σελίδα από το κινητό ή tablet σου.
                Στείλε τον σύνδεσμο: <strong>{window.location.origin}/install-calendar</strong>
              </AlertDescription>
            </Alert>
          )}
          ...
          <div className="bg-[#00ffba]/5 border border-[#00ffba]/20 p-4 rounded-none">
            ...
            <ol className="list-decimal list-inside space-y-1 text-sm text-muted-foreground">
              <li>Άνοιξε το widget σε νέο tab</li>
              <li>Πρόσθεσέ το στην αρχική οθόνη</li>
              <li>Θα έχεις άμεση πρόσβαση στο ημερολόγιο!</li>
            </ol>
          </div>
          ...
          {isInstalled ? (
            <div className="text-center py-8">
              ...
              <h3 className="text-lg font-semibold mb-2">Το widget είναι εγκατεστημένο!</h3>
              <p className="text-sm text-muted-foreground">
                Μπορείς να το βρεις στην αρχική οθόνη της συσκευής σου
              </p>
            </div>
          ) : (
            <>
                    ...
                    <>
                      {isInstallable ? (
                        ...
                        <div className="bg-gray-50 p-4 rounded-none">
                          ...
                          <ol className="list-decimal list-inside space-y-1 text-sm text-muted-foreground">
                            <li>Άνοιξε το widget πατώντας το κουμπί παραπάνω</li>
