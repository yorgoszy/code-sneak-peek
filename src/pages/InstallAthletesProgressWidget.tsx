...
import { Download, Smartphone, Check, Monitor, ArrowLeft, TrendingUp } from 'lucide-react';
import { Alert, AlertDescription } from '@/components/ui/alert';

export default function InstallAthletesProgressWidget() {
  ...
  const handleOpenWidget = () => {
    window.open('/athletes-progress-widget', '_blank');
  };
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <Card className="max-w-2xl w-full rounded-none relative">
        ...
        <CardHeader className="text-center pt-12">
          ...
          <CardDescription>
            Εγκατάστησε το widget προόδου αθλητών για γρήγορη πρόσβαση στα στατιστικά
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          {!isMobile && (
            <Alert className="rounded-none border-[#cb8954]/20 bg-[#cb8954]/5">
              ...
              <AlertDescription>
                ...
                Στείλε τον σύνδεσμο: <strong>{window.location.origin}/install-athletes-progress</strong>
              </AlertDescription>
            </Alert>
          )}
          ...
          <div className="bg-[#00ffba]/5 border border-[#00ffba]/20 p-4 rounded-none">
            ...
            <ol className="list-decimal list-inside space-y-1 text-sm text-muted-foreground">
              ...
              <li>Θα έχεις άμεση πρόσβαση στην πρόοδο αθλητών!</li>
            </ol>
          </div>
