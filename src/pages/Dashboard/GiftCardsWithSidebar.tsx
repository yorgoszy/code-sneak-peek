...
import { GiftCardManagement } from "@/components/gift-cards/GiftCardManagement";

const GiftCardsWithSidebar = () => {
          ...
          {(isMobile || isTablet) && (
            <nav className="sticky top-0 z-40 bg-white border-b border-gray-200 px-3 py-4 shadow-sm lg:hidden">
              <div className="flex items-center">
                ...
                <h1 className="ml-4 text-lg font-semibold text-gray-900">Gift Cards</h1>
              </div>
            </nav>
          )}
...
export default GiftCardsWithSidebar;
