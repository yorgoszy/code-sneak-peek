      ...
      <div className="flex-1 flex flex-col min-w-0">
        <main className="flex-1 p-6">
          ...
          <div className="flex items-center justify-between mb-6">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 mb-2">Αποτελέσματα Τεστ</h1>
              <p className="text-gray-600">
                Προβολή και ανάλυση αποτελεσμάτων τεστ αθλητών
              </p>
            </div>
...
export default TestResultsWithSidebar;