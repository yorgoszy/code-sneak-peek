    ...
    return (
      <div className="min-h-screen bg-[hsl(var(--auth-black))] flex items-center justify-center">
        <div className="text-center">
          <img src="/hyperkids-logo-extended.jpg" alt="HYPERKIDS" className="h-12 mx-auto mb-4 animate-pulse" />
      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <Link to="/" className="inline-flex items-center justify-center">
            <img src="/hyperkids-logo-extended.jpg" alt="HYPERKIDS" className="h-16" />
          </Link>
        </div>
