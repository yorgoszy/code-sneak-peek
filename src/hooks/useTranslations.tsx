...
export const useTranslations = () => {
  ...
  const translations = {
    el: {
      ...
      login: "Σύνδεση",
      dashboard: "Dashboard",
      getStarted: "ΚΛΕΙΣΕ ΔΟΚΙΜΑΣΤΙΚΟ",
      contactBtn: "ΕΞΕΡΕΥΝΗΣΕ ΤΟ ΓΥΜΝΑΣΤΗΡΙΟ",
    ...
    en: {
      ...
      login: "Login",
      dashboard: "Dashboard",
      getStarted: "BOOK A TRIAL",
      contactBtn: "EXPLORE THE GYM",
      ...
      coachDescription: "My name is Georgios Zygouris. I am a graduate of the School of Physical Education and Sport Science at Aristotle University of Thessaloniki (2023). I am a professional Muay Thai athlete and certified coach since 2024. Through my dual perspective as both athlete and educator, I have created a training environment where children, teenagers, and adults don't just learn a sport—they discover their strengths, build character through athletics, and find their unique place in the world of sports.\n\nOur goal is not only physical improvement, but also the cultivation of confidence, character, and core values.",
      visionDescription: "Combining scientific knowledge with real-world experience, we implement skill development and performance-focused training, tailored to every age and stage. We see movement as something more than physical — it is self-expression, confidence, and the power to grow through challenge. Our mission is to help young people trust the process and explore their potential in a safe, supportive space.\nWe shape character, teaching respect, discipline, perseverance, and teamwork.\n\nFor us, tomorrow starts today. Step by step. With trust in the process. With the courage to go further. With the will to push beyond limits.",
