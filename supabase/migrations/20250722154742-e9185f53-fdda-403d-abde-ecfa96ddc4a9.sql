-- Update function to have better error handling and debugging
...
BEGIN
  ...
  -- Debug logging
  RAISE NOTICE 'User: %, Visit packages total: %, used: %', user_uuid, visit_packages_total, visit_packages_used;
