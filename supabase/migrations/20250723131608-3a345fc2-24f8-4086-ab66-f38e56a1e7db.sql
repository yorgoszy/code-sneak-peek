-- Ενημέρωση της συνάρτησης get_user_available_bookings για να περιλαμβάνει videocall packages
...
BEGIN
  ...
  IF hypergym_subscription.id IS NOT NULL THEN
    ...
    result := jsonb_build_object(
      ...
      'has_videocall', videocall_subscription.id IS NOT NULL OR single_videocall_purchases > 0 OR videocall_packages_total > 0,
  ...
  ELSIF single_videocall_purchases > 0 OR videocall_packages_total > 0 THEN
    result := jsonb_build_object(
